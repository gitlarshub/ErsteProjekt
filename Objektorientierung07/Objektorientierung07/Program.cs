...
tierheim.AddAnimal(new Cat("Luna", new DateTime(2020, 5, 15)));
tierheim.AddAnimal(new Cat("Milo", new DateTime(2018, 3, 10)));
tierheim.AddAnimal(new Cat("Tom", new DateTime(2019, 7, 25)));

tierheim.AddAnimal(new Dog("Burak", new DateTime(2017, 6, 5)));
tierheim.AddAnimal(new Dog("Fritz", new DateTime(2021, 1, 20)));
